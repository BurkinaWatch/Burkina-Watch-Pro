...
**How to apply:** Keep the Node/npm engine and package-manager declarations aligned with the tested local runtime, retain a matching `.nvmrc`, and set production mode in the start command rather than globally.