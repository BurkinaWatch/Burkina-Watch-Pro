...
import { Home, MapPin, FileText, AlertCircle, Heart, Info, Scale, User, LogOut, Trophy, Cross, Newspaper, Calendar } from "lucide-react";
...
export default function HamburgerMenu({ open, onOpenChange }: HamburgerMenuProps) {
  ...
  const infoItems = [
    ...
    { href: "/events", icon: Calendar, label: "Burkina Events" },
