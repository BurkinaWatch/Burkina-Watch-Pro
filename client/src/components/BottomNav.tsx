...
import { Home, Map, Plus, AlertCircle, User, Cross, Hotel } from "lucide-react";
...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { icon: Hotel, label: "Hôtels", path: "/hotels", testId: "nav-hotels", color: "from-indigo-400 to-indigo-600", tipId: "nav-hotels", tip: "Hôtels et Auberges" },
