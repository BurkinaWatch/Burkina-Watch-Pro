...
export interface Boutique {
  id: string;
  nom: string;
  categorie: "Supermarché" | "Alimentation" | "Électronique" | "Mode" | "Quincaillerie" | "Cosmétiques" | "Téléphonie" | "Ameublement" | "Pharmacie" | "Librairie" | "Sport" | "Bijouterie" | "Électroménager";
  adresse: string;
  quartier: string;
  ville: string;
  region: string;
