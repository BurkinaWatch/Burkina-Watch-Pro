...
import { Home, MapPin, FileText, AlertCircle, Heart, Info, Scale, User, LogOut, Cross, Newspaper, Calendar, Navigation, Sparkles, Bell, Shield, Utensils, ShoppingBag, Fuel, Store, Landmark, Bus, Film, Hospital, GraduationCap, Trophy, Hotel, BookOpen, Zap, Smartphone, Building2, Camera, Clock, Compass } from "lucide-react";
...
export default function HamburgerMenu({ open, onOpenChange }: HamburgerMenuProps) {
  ...
  const mainMenuItems = [
    ...
    { href: "/burkina-pratique", icon: Compass, label: "Burkina Pratique", color: "text-amber-600 dark:text-amber-400" },
  ...
  const vieQuotidienneItems = [
    { href: "/telephonie", icon: Smartphone, label: "Agences Téléphonie", color: "text-orange-500 dark:text-orange-400" },
    ...
    { href: "/lieux-de-culte", icon: Heart, label: "Églises & Mosquées", color: "text-emerald-600 dark:text-emerald-500" },
    { href: "/gares", icon: Bus, label: "Gares Routières", color: "text-blue-600 dark:text-blue-500" },
    { href: "/hotels", icon: Hotel, label: "Hôtels & Auberges", color: "text-indigo-600 dark:text-indigo-500" },
    { href: "/mairies-prefectures", icon: Landmark, label: "Mairies & Préfectures", color: "text-blue-600 dark:text-blue-500" },
