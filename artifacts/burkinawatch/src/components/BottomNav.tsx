...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { icon: Plus, label: "Dénoncer", path: "/publier", testId: "nav-publish", highlight: true, color: "from-red-500 via-orange-400 to-yellow-400", tipId: "nav-publish", tip: "Signalez un incident" },
