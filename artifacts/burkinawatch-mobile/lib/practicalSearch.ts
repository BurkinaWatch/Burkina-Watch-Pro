...
const rules = [
  { key: 'pharmacies', href: '/pharmacies', label: 'Pharmacies', terms: ['pharmacie', 'médicament', 'medicament', 'garde'] },
  { key: 'urgences', href: '/urgences', label: 'Urgences', terms: ['urgence', 'urgent', 'secours', 'ambulance', 'police'] },
  { key: 'retrait', href: '/banques', label: "Retrait d'argent", terms: ['argent', 'retirer', 'retrait', 'banque', 'atm', 'guichet', 'gab'] },
  { key: 'stations', href: '/stations', label: 'Station-service', terms: ['station', 'essence', 'carburant', 'fuel', 'diesel'] },
  { key: 'depannage', href: '/boutiques', label: 'Dépannage', terms: ['dépannage', 'depannage', 'panne', 'voiture', 'mécanique', 'mecanique', 'plombier'] },
  { key: 'manger', href: '/restaurants', label: 'Manger', terms: ['manger', 'restaurant', 'maquis', 'café', 'cafe', 'repas', 'déjeuner', 'dejeuner'] },
  { key: 'transport', href: '/gares', label: 'Transport', terms: ['transport', 'gare', 'bus', 'taxi', 'voyage'] },
  { key: 'reparation', href: '/telephonie', label: 'Réparation', terms: ['réparation', 'reparation', 'téléphone', 'telephone', 'mobile', 'cassé', 'casse'] },
  { key: 'commerces', href: '/boutiques', label: 'Commerces & artisans', terms: ['acheter', 'ciment', 'matériaux', 'materiaux', 'boutique', 'magasin', 'artisan'] },
];

export const normalizePracticalSearch = (value: string) =>
  value.toLocaleLowerCase('fr-FR').normalize('NFD').replace(/\p{Diacritic}/gu, '').trim();
