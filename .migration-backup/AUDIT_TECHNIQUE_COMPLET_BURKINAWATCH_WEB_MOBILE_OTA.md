...
La voie la plus sûre consiste à conserver le Web intact, stabiliser Railway et PostgreSQL, concevoir l’authentification Mobile, puis ajouter Expo dans un espace séparé avec des contrats API explicites.# Audit technique complet — BurkinaWatch Web + Mobile Expo + OTA
